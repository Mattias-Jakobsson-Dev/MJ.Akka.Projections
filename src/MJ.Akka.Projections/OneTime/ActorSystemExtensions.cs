...
public static class ActorSystemExtensions
{
    public static IOneTimeProjection<TId, TDocument> CreateOneTimeProjection<TId, TDocument>(
        ...
        IProjection<SimpleIdContext<TId>, InMemoryProjectionContext<TId, TDocument>, SetupInMemoryStorage> projection,
        ...
        where TDocument : class
    {
        ...
        private class Result(
            ILoadProjectionContext<SimpleIdContext<TId>, InMemoryProjectionContext<TId, TDocument>> loader,
            IProjection<SimpleIdContext<TId>, InMemoryProjectionContext<TId, TDocument>, SetupInMemoryStorage> projection)
            : IOneTimeProjection<TId, TDocument>.IResult
        {
            public async Task<TDocument?> Load(SimpleIdContext<TId> id)
            {
