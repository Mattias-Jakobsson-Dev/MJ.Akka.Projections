...
public static class CreateDocumentExtensions
{
    ...
    public static ISetupEventHandlerForProjection<TIdContext, RavenDbProjectionContext<TDocument>, TEvent>
        CreateDocument<TIdContext, TDocument, TEvent>(
            this ISetupEventHandlerForProjectionWithoutDocument<TIdContext, TDocument, TEvent> setup,
            Func<TEvent, DocumentHandlingMetaData<SimpleIdContext<string>>, TDocument> create)
        where TIdContext : IProjectionIdContext
    ...
    public static ISetupEventHandlerForProjection<TIdContext, RavenDbProjectionContext<TDocument>, TEvent>
        CreateDocument<TIdContext, TDocument, TEvent>(
        this ISetupEventHandlerForProjectionWithoutDocument<TIdContext, TDocument, TEvent> setup,
        Func<TEvent, DocumentHandlingMetaData<SimpleIdContext<string>>, Task<TDocument>> create)
        where TIdContext : IProjectionIdContext
    ...
    public static ISetupEventHandlerForProjection<TIdContext, RavenDbProjectionContext<TDocument>, TEvent> 
        CreateDocument<TIdContext, TDocument, TEvent>(
        this ISetupEventHandlerForProjectionWithoutDocument<TIdContext, TDocument, TEvent> setup,
        Func<TEvent, DocumentHandlingMetaData<SimpleIdContext<string>>, CancellationToken, Task<TDocument>> create)
        where TIdContext : IProjectionIdContext
