...
public class ProjectToInMemoryStoreWithBatchedStorageBenchmarks 
    : BaseProjectionBenchmarks<SimpleIdContext<string>, InMemoryProjectionContext<string, InMemoryTestProjection.TestDocument>, SetupInMemoryStorage>
{
    ...
    protected override IProjection<SimpleIdContext<string>, InMemoryProjectionContext<string, InMemoryTestProjection.TestDocument>, SetupInMemoryStorage> 
