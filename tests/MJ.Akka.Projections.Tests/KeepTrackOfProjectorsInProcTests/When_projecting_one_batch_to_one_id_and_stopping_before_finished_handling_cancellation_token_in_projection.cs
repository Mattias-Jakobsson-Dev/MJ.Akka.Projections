...
public class When_projecting_one_batch_to_one_id_and_stopping_before_finished_handling_cancellation_token_in_projection(
    When_projecting_one_batch_to_one_id_and_stopping_before_finished_handling_cancellation_token_in_projection.Fixture fixture)
    : IClassFixture<When_projecting_one_batch_to_one_id_and_stopping_before_finished_handling_cancellation_token_in_projection.Fixture>
{
    [Fact]
        ...
        public async Task InitializeAsync()
        {
            ...
            var projectionConfiguration = new ProjectionConfiguration<
                ...
                projection.Configure(
                    new SetupProjection<SimpleIdContext<string>, InMemoryProjectionContext<string, TestDocument<string>>>()).Build());
            ...
            var projectorTask = projector
                .ProjectEvents(
                    ImmutableList.Create(new EventWithPosition(
                        new Events<string>.DelayHandlingWithCancellationToken(
                            id,
