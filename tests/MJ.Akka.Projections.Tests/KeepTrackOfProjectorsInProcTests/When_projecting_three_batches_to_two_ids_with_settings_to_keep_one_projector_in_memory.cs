    ...
    : IClassFixture<When_projecting_three_batches_to_two_ids_with_settings_to_keep_one_projector_in_memory.Fixture>
{
    ...
    {
        fixture.ThirdResponse.ShouldBeOfType<Messages.Acknowledge>();
    }

    [Fact]
    public void Then_first_projector_should_still_be_running()
    {
        fixture.FirstProjector.ShouldNotBeNull();
    }

    [Fact]
    public void Then_second_projector_should_be_stopped()
    {
        fixture.SecondProjector.ShouldBeNull();
    }
    ...
    public class Fixture : global::Akka.TestKit.Xunit2.TestKit, IAsyncLifetime
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            var thirdProjector = await factory.GetProjector(firstId, projectionConfiguration);
