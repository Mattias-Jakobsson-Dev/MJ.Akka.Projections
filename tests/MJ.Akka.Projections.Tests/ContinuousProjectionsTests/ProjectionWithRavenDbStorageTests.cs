        ...
        IClassFixture<NormalTestKitActorSystem>
{
        ...
        IImmutableList<StorageFailures> storageFailures) : RavenDbProjection<TestDocument<string>>
    {
        ...
        public override ISetupProjection<string, RavenDbProjectionContext<TestDocument<string>>> Configure(
            ISetupProjection<string, RavenDbProjectionContext<TestDocument<string>>> config)
        {
            ...
            return config
                ...
                .On<Events<string>.DelayHandlingWithoutCancellationToken>(
                    x => x.DocId,
                    async (evnt, context) =>
                    {
                ...
                .On<Events<string>.DelayHandlingWithCancellationToken>(
                    x => x.DocId,
                ...
                .On<Events<string>.FailProjection>(
                    x => x.DocId,
                    (evnt, context) =>
                    {
                        context.ModifyDocument(doc =>
